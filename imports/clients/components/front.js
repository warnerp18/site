  ...
  render(){
    return (
      <div>
        ...
        <p className='contain580'>My life plan for as long as I can remember has been to graduate college, take my commision as an officer in the Army, and follow my dad's footsteps into Special Forces. Unfortunately, due to some medical issues that occured during one of my tours to Afghanistan and spending a few months at Walter Reed Army Medical Center I was not allowed back in the military.</p>
